                      ...
                      {loading ? (<Loader />) : (
                        blogs.map((blog) => {
                          return (
                            ...
                            <div className="w-full h-fit border border-transparent shadow-xl p-2 rounded-md flex flex-col justify-between hover:shadow-2xl hover:border hover:bg-slate-100 hover:bg-opacity-70 ">
