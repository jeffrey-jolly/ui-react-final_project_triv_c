          ...
          <div className='w-5/6 h-full'>
            ...
            <div className='flex  flex-row justify-between w-full mt-7'>
              ...
              <section className=' max-w-7xl mx-auto flex flex-col justify-between w-1/4 h-20'>
                <div className='border border-transparent shadow-lg bg-opacity-70  mr-4  p-5  rounded-md flex flex-co justify-between hover:shadow-2xl hover:border bg-red-300'>
                  <div className='flex flex-row'>
                    ...
                    <p className='ml-2'>NUMBER OF POSTS: <span className='font-semibold'>{blogs.length}</span></p>
                  </div>
                </div>
              </section>

              <section className=' max-w-7xl mx-auto flex flex-col  w-1/4 h-20'>
                <div className=' border border-transparent shadow-lg bg-opacity-70  mr-4 p-5 rounded-md flex flex-col justify-between hover:shadow-2xl hover:border bg-yellow-200'>
                  <div className='flex flex-row'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <p className='ml-2'>VIEWS: <span className=' font-semibold'>{appContext.count}</span> </p>
                  </div>
                </div>
              </section>

              <section className=' max-w-7xl mx-auto flex flex-col w-1/4 h-20 '>
                <div className='border border-transparent shadow-lg bg-opacity-70 mr-4 p-5 bg-green-300 rounded-md flex flex-col justify-between hover:shadow-2xl hover:border '>
                  <div className='flex flex-row'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <section className='h-full max-w-7xl mx-auto flex flex-col justify-between p-5 w-1/2'>
                <div className='border border-transparent shadow-lg mr-4 h-2/3 mt-4 p-6  rounded-md flex flex-col justify-between hover:shadow-2xl hover:border '>
                  <div className="inline-flex justify-between items-center ">
                    <p className='font-bold text-2xl text-gray-600'>BLOGS</p>
                    <Link to="/create">
