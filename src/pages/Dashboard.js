  ...
  return (
    <div className='max-h-full'>
      ...
      <div className="flex flex-row w-full max-h-full">
          <div className="text-xl bg-black max-h-full w-1/6 shadow-2xl text-white  flex flex-col align-bottom justify-between ">
          ...
          <div className='w-5/6 h-full'>
            ...
            <div className='flex  flex-row justify-between w-full'>
              ...
              <section className=' max-w-7xl mx-auto flex flex-col justify-between w-1/4 h-20'>
                <div className='border border-transparent shadow-lg mr-4  p-4  rounded-md flex flex-co justify-between hover:shadow-2xl hover:border '>
              ...
              <section className=' max-w-7xl mx-auto flex flex-col  w-1/4 h-20'>
                <div className=' border border-transparent shadow-lg mr-4 p-4 rounded-md flex flex-col justify-between hover:shadow-2xl hover:border'>
                  <div className='flex flex-row'>
            ...
            <div className='flex  flex-row justify-between w-full h-full'>
              ...
              <section className='h-full max-w-7xl mx-auto flex flex-col justify-between p-4 w-1/2'>
                <div className='border border-transparent shadow-lg mr-4 h-2/3 mt-4 p-6 bg-white rounded-md flex flex-col justify-between hover:shadow-2xl hover:border '>
                  ...
                  <div className=' h-full'>
                    ...
                    <div className='w-full h-full mx-auto flex overflow-hidden hover:overflow-y-scroll flex-col justify-between'>
                      {loading ? (<Loader />) : (
                        blogs.map((blog) => {
                          return (
                            ...
                            <div className="w-full h-full border border-transparent shadow-xl p-2 rounded-md flex flex-col justify-between hover:shadow-2xl hover:border hover:bg-slate-100 hover:bg-opacity-70 ">
                            <Link to={`/single-page/${blog.id}`}>  <pre>
              ...
              <section className='h-full max-w-7xl mx-auto flex flex-col p-4 w-1/2'>
